            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      {formData.images.map((image, index) => (
                        <div key={index} className="relative group aspect-square">
                          ...
                          <button
                            ...
                            className="absolute top-2 right-2 bg-slate-700 hover:bg-slate-800 text-white p-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"
                          >
              ...
              <div className="flex items-center justify-end space-x-4">
                <Button
                  ...
                  variant="outline"
                  onClick={() => router.back()}
                  className="border-slate-300 hover:border-slate-400 text-slate-700 hover:text-slate-800 bg-slate-50 hover:bg-slate-100"
                >
                  Cancel
                </Button>
                <Button 
